...
(
    512
) not null comment 'accessKey',
    `secretKey` varchar
(
    512
) not null comment 'secretKey',
...
insert into `interface_info` (`name`, `description`, `url`, `requestHeader`, `responseHeader`, `status`,
                              `method`,
                              `userId`)
